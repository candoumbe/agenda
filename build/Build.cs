            ...
            .Executes(() =>
            {
                ...
                Registries.ForEach(registry =>
                {
                    ...
                    // {
                        ...
                        Bash($"echo {registry.Password} | docker login ghcr.io -u {this.Get<IHaveGitHubRepository>().GitRepository.GetGitHubOwner()} --password-stdin");
                        Verbose("Logged into {RegistryUri}", registry.Uri);
