...
## Learning — 2026-09-02: CleanImages 403 fix & commit convention
- Convention de commit constatée sur ce dépôt : Conventional Commits (`chore(scope): ...`, `fix(scope): ...`, `docs(scope): ...`), messages courts en anglais, sujet impératif. Les commits atomiques par préoccupation (deps séparées du fix fonctionnel) sont la norme.
